 ...
 */
class getBmcRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BmcRepository' shared autowired service.
     *
     * @return \App\Repository\BmcRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BmcRepository.php';

        return $container->privates['App\\Repository\\BmcRepository'] = new \App\Repository\BmcRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
