 ...
 */
class getAssistanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssistanceRepository' shared autowired service.
     *
     * @return \App\Repository\AssistanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssistanceRepository.php';

        return $container->privates['App\\Repository\\AssistanceRepository'] = new \App\Repository\AssistanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
