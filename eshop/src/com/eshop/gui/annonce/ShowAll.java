...
public class ShowAll extends Form {
    ...
    Label  lid, ltitre,ldescription,ldomaine,lstatut;
    ...
    private Container makeModelWithoutButtons(annonce annonce) {
        ...
        ldescription.setUIID("labelDefault");
         ...
         ldomaine = new Label("domaine : " + annonce.getDomaine());
        ldomaine.setUIID("labelDefault");
        
        lstatut = new Label("statut : " + annonce.getStatut());
        lstatut.setUIID("labelDefault");
        ...
        annonceModel.addAll(                
             lid, ltitre,ldescription,ldomaine,lstatut
        );
