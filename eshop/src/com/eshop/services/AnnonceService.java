...
//                                          +"&stock_p="+t.getStock_p();
            String url =Statics.BASE_URL+"annonce/json/addannonce?titre="+t.getTitre()+"&description="+t.getDescription()+"&domaine="+t.getDomaine()+"&statut="+t.getStatut(); 
                ...
                annonce annonce = new annonce();
                      ...
                      float id = Float.parseFloat( obj.get("id").toString() ) ; 
                        ...
                        annonce.setDescription((String)obj.get("description").toString());
                         annonce.setDomaine((String)obj.get("domaine").toString());
                        annonce.setStatut((String)obj.get("statut").toString());
    ...
    public int manage(annonce annonce) {
        ...
        cr.setHttpMethod("GET");                                               
            cr.setUrl(Statics.BASE_URL + "annonce/json/upup/?id="+(int)annonce.getId()+"&titre="+annonce.getTitre()+"&description="+annonce.getDescription()+"&domaine="+annonce.getDomaine()+"&statut="+annonce.getStatut());
        ...
        cr.addArgument("domaine", annonce.getDomaine());
        cr.addArgument("statut", annonce.getStatut());
  ...
  public boolean modifier(annonce annonce) {
    String url = Statics.BASE_URL +"annonce/json/update"+"?titre="+annonce.getTitre()+"&description="+annonce.getDescription()+"&domaine="+annonce.getDomaine()+"&statut="+annonce.getStatut()+"&id="+(int)annonce.getId();
    ...
    req.addArgument("domaine", annonce.getDomaine());
    req.addArgument("statut", annonce.getStatut());
    //req.addArgument("dateCrea", new SimpleDateFormat("yyyy-MM-dd").format(annonce.getDate()));
