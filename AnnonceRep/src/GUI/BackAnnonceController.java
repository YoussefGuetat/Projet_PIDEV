 ...
 * @author hgygz
 */
public class BackAnnonceController implements Initializable {
       public void start(Stage primaryStage) {
       
        try {
            Parent root = FXMLLoader.load(getClass().getResource("BackAnnonce.fxml"));
            ...
            Logger.getLogger(annonce.Annonce.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
public void initialize(URL location, ResourceBundle resources) {
    ...
    try {
        ...
        Annonce.Bmc bmc = bmcService.getBmcByAnnonceId(annonce.getId());
        if (bmc == null) {
