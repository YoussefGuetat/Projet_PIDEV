...
public function annoncestats(): Response
{
...
#[Route('/annonce/search/results', name: 'app_annonce_search_results', methods: ['POST'])]
...
public function sortback(Request $request, AnnonceRepository $annonceRepository, string $sortOrder): Response
{
    $annonces = $annonceRepository->findAllSortedByTitre($sortOrder);
